...
class ModeConfigurationPage {
  ...
  draw() {
    ...
    const button1 = new Button("b1", "Contínuo", () => {
      this.goToContinuousModePage();
    });
    const button2 = new Button("b2", "Pulsado", () => {
      this.goToPulsedModePage();
    });
    const button3 = new Button("b3", "Pulso Único", () => {
      this.goToSinglePulsePage();
    });
    const button4 = new Button("b4", "Voltar", () => {
