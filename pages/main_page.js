...
class MainPage {
    ...
    draw(){
        ...
        const button1 = new Button('b1', 'Cirurgia', ()=>{this.goToOtherPage()});
        const button2 = new Button('b2', 'Terapia', ()=>{alert('Terapia')});
        const button3 = new Button('b3', 'Configurações', ()=>{alert('Configurações')});
        const button4 = new Button('b4', 'Bloquear', ()=>{alert('Bloquear')});
